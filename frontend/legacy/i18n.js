...
(function () {
  const T = {
    zh: {
      ...
      'confirm.delete_session': '归档「{name}」？归档后对话及其文件进入「设置 → 存储」的回收站，可随时恢复。',
    ...
    en: {
      ...
      'confirm.delete_session': 'Archive "{name}"? The conversation and its files go to the recycle bin under Settings → Storage and can be restored.',
